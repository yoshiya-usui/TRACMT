...
4a) If your compiler supports C++11, you can compile TRACMT by "make -f Makefile_C++11" command.
4b) If your compiler does not supports C++11, download mt19937-64.tgz from http://math.sci.hiroshima-u.ac.jp/m-mat/MT/mt64.html and rename mt19937-64.c to mt19937-64.cpp. After copying mt19937-64.cpp and mt64.h to the source-file directory of TRACMT, you can compile TRACMT by make command (Make -f Makefile).
